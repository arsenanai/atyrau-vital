...
<head>
  ...
  <title>Уборка офисов в Атырау - AVGM LTD</title>
  ...
  <meta name="description" content="Сколько стоит выезд менеджера для оценки предстоящей уборки? Мы приедем к вам бесплатно, только позвоните 😉">
</head>
          ...
          <div class="row mb-3 pb-3">
            <div class="col-xl-10 col-lg-10 col-md-12 my-4 py-4">
              <div class="offer-container my-4 py-4">
                <h1 class="mt-4 pt-4">
                  Уборка офисов в Атырау
                </h1>
                <h6 class="w-50" v-if="offers[selectedPage].description">
                  Профессиональная уборка по цене приходящей уборщицы
                </h6>
                <br>
